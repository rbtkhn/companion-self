...
| 5.2 | **Dashboard:** Show "What's next" per skill (e.g. THINK: keep reading; WRITE: try a short story; WORK: one small project). WORK line may use IX-C for phrasing. Include one line: "Designed for up to 2 hours of screen-based learning per day" (or link to [Alpha School reference](skill-work/skill-work-alpha-school/alpha-school-reference.md) §3). | UI. |
