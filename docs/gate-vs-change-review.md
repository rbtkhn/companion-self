...
- [template-instance-contract.md](template-instance-contract.md) (companion-self) — compatibility roles
- [identity-fork-protocol.md](https://github.com/rbtkhn/grace-mar/blob/main/docs/identity-fork-protocol.md) (grace-mar) — IFP §4.1 workflow and §4.3 material escalation
- [boundary-review-queue.md](https://github.com/rbtkhn/grace-mar/blob/main/docs/boundary-review-queue.md) (grace-mar) — boundary classification vs gate
- [change-review.md](change-review.md) (companion-self) — governed self-revision doctrine
