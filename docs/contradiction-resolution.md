...
**See also:** [CONTRADICTION-ENGINE-SPEC.md](CONTRADICTION-ENGINE-SPEC.md) (governed identity-diff workflow, UI, merge, audit), [identity-fork-protocol.md](identity-fork-protocol.md)
