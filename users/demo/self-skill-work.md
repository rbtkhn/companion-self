# self-skill-work (Demo)

Schema tag: **WORK**. Making and doing. Module intent: WORK serves as tutor for the companion in making, planning, execution, and creation; human-gated.
...
Life mission in `self.md`; WORK goals align with it.
