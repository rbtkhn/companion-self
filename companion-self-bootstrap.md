...
5. **Optional:** Add `users/_template/` with minimal SELF, self-skill-read, self-skill-write, self-skill-work, self-evidence, recursive-gate, self-memory templates (structure only). Add a short how-instances-consume-upgrades or merge section.
...
- Schema templates: self.md, self-knowledge.md, self-curiosity.md, self-personality.md, self-skill-read.md, self-skill-write.md, self-skill-work.md, self-evidence.md, recursive-gate.md, self-memory.md in users/_template/
