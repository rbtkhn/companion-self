...
- **SELF / self-skill-read / self-skill-write / self-skill-work / EVIDENCE / PENDING-REVIEW / MEMORY templates** — schema and structure only; instance keeps its own copies and updates them to match the template when upgrading
...
- **`users/<id>/`** — The Record (SELF, self-skill-read, self-skill-write, self-skill-work, EVIDENCE, etc.) for a real companion. Template has no Record; instance must never replace it with template content.
...
| `docs/IDENTITY-FORK-PROTOCOL.md` | Protocol: Sovereign Merge Rule, schema (SELF, self-skill-*, EVIDENCE), evidence linking. |
...
| `users/_template/self-skill-read.md` | READ (self-skill-read) scaffold. |
...
| `users/_template/EVIDENCE.md` | EVIDENCE schema/structure scaffold. |
| `users/_template/PENDING-REVIEW.md` | Staging scaffold. |
| `users/_template/MEMORY.md` | Ephemeral context scaffold (optional). |
| `users/_template/LIBRARY.md` | Curated lookup sources scaffold (optional; bounded lookup extension). |
